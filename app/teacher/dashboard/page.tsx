...
import { BookOpen, Clock, Users, Plus, BarChart, TrendingUp, Award, CheckCircle2 } from "lucide-react"
            ...
            <Card key={stat.title} className="overflow-hidden border-none shadow-md">
              ...
              <CardContent>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <p className={`text-xs flex items-center ${stat.trendUp ? "text-green-500" : "text-red-500"}`}>
                    {stat.trendUp ? (
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
              <Card className="col-span-4">
                <CardHeader>
                  ...
                  <CardDescription>Quizzes taken and student engagement in the past week</CardDescription>
                </CardHeader>
                ...
                <div className="grid gap-4 md:grid-cols-3">
                  <div className="flex items-center gap-3 p-4 rounded-xl bg-muted/50">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">94% Average</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-4 rounded-xl bg-muted/50">
                    <div className="h-10 w-10 rounded-full bg-primary/10 flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">92% Average</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-4 rounded-xl bg-muted/50">
                    <div className="h-10 w-10 rounded-full bg-primary/10 flex items-center justify-center">
                    ...
                    <div>
                      <div className="font-medium">Ashley Williams</div>
                      <div className="text-sm text-muted-foreground">89% Average</div>
                    </div>
                  </div>
                </div>
              </CardContent>
          ...
          <TabsContent value="analytics" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Percentage of students who completed each quiz</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="font-medium">World History: Ancient Civilizations</div>
                      <div className="text-sm text-muted-foreground">18/25 students completed</div>
                    </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">32/35 students completed</div>
                    </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">15/28 students completed</div>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <div className="text-sm font-medium">Biology Quiz, Question 3</div>
                        <div className="text-xs text-muted-foreground">75% incorrect</div>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <div className="text-sm font-medium">Algebra Quiz, Question 7</div>
                        <div className="text-xs text-muted-foreground">68% incorrect</div>
                      </div>
                      <Button variant="outline" size="sm">
                        Review
                      </Button>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <div className="text-sm font-medium">Chemistry Quiz, Question 5</div>
                        <div className="text-xs text-muted-foreground">62% incorrect</div>
                      </div>
                      <Button variant="outline" size="sm">
                        Review
                      </Button>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div>
                      <div className="flex items-center justify-between">
                        <div className="font-medium text-sm">World History Quiz</div>
                  ...
                  <div className="flex flex-col md:flex-row">
                    <div className="bg-primary/10 p-6 md:w-1/4 flex flex-col justify-between">
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground mt-1">{quiz.topic}</div>
                      </div>
                    ...
                    <div className="p-6 md:w-3/4 flex flex-col">
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        <div className="flex flex-col">
                          ...
                          <div className="mt-1 font-medium">{quiz.createdAt}</div>
                        </div>
                        <div className="flex flex-col">
                          <div className="text-sm font-medium text-muted-foreground">Submissions</div>
                          <div className="mt-1 font-medium">{quiz.submissions} students</div>
                        </div>
                        <div className="flex flex-col">
                          ...
                          >
                            {quiz.avgScore}%{quiz.avgScore >= 80 && <CheckCircle2 className="h-4 w-4 ml-1" />}
                          </div>
                        </div>
                      </div>
